...
import { MailIcon, PhoneIcon } from '../../components/tenant/icons';
              ...
              <tr key={t.id}>
                ...
                <td className="px-5 py-4">
                  <div className="flex justify-end gap-1.5">
                    ...
                    <a href={`mailto:${t.email}`} aria-label={`Email ${t.name}`} className="flex h-8 w-8 items-center justify-center rounded-full text-muted hover:bg-gray-100 hover:text-ink">
                      <MailIcon size={16} />
                    </a>
                  </div>
                </td>
